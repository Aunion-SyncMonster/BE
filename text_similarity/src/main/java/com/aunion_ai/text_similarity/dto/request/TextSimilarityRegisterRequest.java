package com.aunion_ai.text_similarity.dto.request;
...
/**
 * packageName    : com.aunion_ai.text_similarity.dto.request <br>
...
public class TextSimilarityRegisterRequest {
    ...
    @Schema(description = "LabSE 점수", example = "0.79")
    ...
    public static TextSimilarityEntity toTextSimilarityEntity(TextSimilarityRegisterRequest request) {
        return TextSimilarityEntity.builder()
                .totalProjectId(request.getTotalProjectId())
                .score(request.getScore())
                .inputOriginalText(request.getInputText())
                .outputTranslationText(request.getTranslationText())
                .inputOriginalTextKey(request.getInputTextKey())
                .outputTranslationTextKey(request.getTranslationTextKey())
                .translationApiType(request.getTranslationApiType())
                ...
                .e5(request.getE5())
                .labse(request.getLabse())
                .bertscore(request.getBertscore())
                .cometScore(request.getCometScore())
                .build();
    }
}
