 ...
 * fileName       : TTSGetResponse.java<br>
 * author         : Fiat_lux<br>
 * date           : 2025-05-08<br>
 * description    :  TTS 자연스러움 평가 결과 get request response dto class<br>
 * ===========================================================<br>
 * DATE              AUTHOR             NOTE<br>
 * -----------------------------------------------------------<br>
...
@Getter
@AllArgsConstructor
@Schema(description = "Total Project TTS 자연스러움 평가 결과 응답 DTO")
public class TTSGetResponse {
    ...
    public static TTSGetResponse of(TTSNaturalnessEntity entity) {
        if (Objects.isNull(entity)) {
            return null;
        }
        return new TTSGetResponse(
                entity.getId(),
                entity.getTotalProjectId(),
                entity.getInputOriginalKey(),
                entity.getResultTranslationTextKey(),
                entity.getOutputVoiceKey(),
                entity.getMosScore(),
                entity.getScScore(),
                entity.getTtsApiType(),
                entity.getInferenceTime(),
                entity.getStatus(),
                entity.getTaskName(),
                entity.getCreatedDate(),
                entity.getStability(),
                entity.getSimilarityBoost(),
                entity.getStyle(),
                entity.getUseSpeakerBoost(),
                entity.getVoiceId()
        );
    }
}
