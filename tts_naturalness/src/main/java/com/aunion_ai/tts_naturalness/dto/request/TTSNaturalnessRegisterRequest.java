package com.aunion_ai.tts_naturalness.dto.request;
...
/**
 * packageName    : com.aunion_ai.tts_naturalness.dto.request<br>
...
public class TTSNaturalnessRegisterRequest {
    ...
    public static TTSNaturalnessEntity to(TTSNaturalnessRegisterRequest request) {
        return TTSNaturalnessEntity.builder()
                .totalProjectId(request.getTotalProjectId())
                .inputOriginalKey(request.getInputOriginalKey())
                .resultTranslationTextKey(request.getResultTranslationTextKey())
                .outputVoiceKey(request.getOutputVoiceKey())
                .mosScore(request.getMosScore())
                .scScore(request.getScScore())
                .ttsApiType(request.getTtsApiType())
                .inferenceTime(request.getInferenceTime())
                .status(request.getStatus())
                .taskName(request.getTaskName())
                .stability(request.getStability())
                .similarityBoost(request.getSimilarityBoost())
                .style(request.getStyle())
                .useSpeakerBoost(request.getUseSpeakerBoost())
